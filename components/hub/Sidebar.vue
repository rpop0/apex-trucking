    ...
    <div class="flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 transform h-screen w-64 shrink-0 bg-white transition-all duration-200 ease-in-out -translate-x-56 m-8 sidebar">
      <div class="space-y-8">
        <div>
          ...
          <ul class="mt-5">
            <li class="px-6 py-3 rounded-sm mb-2 ml-8 rounded-l-full" :class="(route.path == '/hub' || route.path == '/hub/') ? 'bg-primary font-bold' : ''">
            ...
            <li v-if="getUserInfo > 0" class="px-6 py-3 rounded-sm mb-2 ml-8 rounded-l-full" :class="(route.path == '/hub/applications' || route.path == '/hub/applications/') ? 'bg-primary font-bold' : ''">
